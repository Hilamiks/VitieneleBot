...
@Component
public class SorceryParamChangeCallbackProcessor extends ParamChangeCallbackProcessor {

    @Override
    protected ParameterType getModifiedParam() {
        return ParameterType.SORCERY;
    }

    @Override
    public UserState getCorrelatingUserState() {
        return UserState.AWAITING_PARAMETER_VALUE_OF_SORCERY;
    }
